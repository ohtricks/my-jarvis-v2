...
```bash
# 1. Clone and enter
git clone https://github.com/SEU_USUARIO/jarvis_v2.git && cd jarvis_v2

# 2. Create Python environment (Python 3.11)
conda create -n jarvis_v2 python=3.11 -y && conda activate jarvis_v2
...
2. Type this command and hit Enter:
   ```bash
    git clone https://github.com/SEU_USUARIO/jarvis_v2.git
   ```
